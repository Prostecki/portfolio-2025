          ...
          <div className=" flex flex-col max-md:gap-8 items-start gap-3 justify-center max-w-[20rem]">
            <address>
              <div className="flex gap-3 items-center">
                ...
                <div>
                  <h1 style={{ fontStyle: 'normal' }} className="text-xl font-bold dark:text-white/80 text-black/80">
                    Email
                  </h1>
                  <h2 style={{ fontStyle: 'normal' }} className="text-lg text-black/80 dark:text-white/80">
