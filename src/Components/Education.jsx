  ...
  return (
    <section className="flex flex-col w-full justify-center items-center">
      <div className="max-w-[50rem] w-full h-max flex justify-between gap-2">
        <div className="w-1/2 bg-slate-900 p-3 py-2 rounded-md drop-shadow-lg flex flex-col border-b-4 border-blue-500">
      ...
      <div className="max-w-[50rem] w-full h-max flex justify-between gap-2">
        <div className="w-1/2"></div>
        <BorderLine />
        <div className="w-1/2 bg-slate-900 p-3 py-2 rounded-md drop-shadow-lg flex flex-col items-start gap-2 border-b-4 border-blue-500">
          <h1 className="text-white font-[600] text-end uppercase mb-2">
            Municipal Adult Education
          </h1>
          <div>
            <ul className="text-white ml-5 list-disc">
              <li className="my-2">Swedish 2</li>
              <li className="my-2">English 6</li>
            </ul>
          </div>
      ...
      <div className="max-w-[50rem] w-full h-max flex justify-between gap-2">
        <div className="w-1/2 bg-slate-900 p-3 py-2 rounded-md drop-shadow-lg flex flex-col items-end border-b-4 border-blue-500">
          <h1 className="text-white font-[600] text-end uppercase mb-2">
